  ...
  const handleResgatar = (passagem: Passagem) => {
    ...
    if (saldo < totalCusto) {
      alert(
        ...
        `Este resgate precisa de ${totalCusto} pts, ` +
        `mas você tem apenas ${saldo} pts.`
      );
    ...
    alert(
      `✓ Sucesso!\n\n` +
      `Foram creditadas ${qtd} passagem(ns) para você.`
    );
  };
    ...
    <main className="max-w-[1200px] mx-auto px-4 sm:px-8 py-10">
      ...
      <section className="text-center mb-10">
        ...
        <p className="text-gray-500 text-lg">
          Converta seus GreenPoints em créditos para seu cartão de transporte.
        </p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-secondary font-bold text-sm mb-6">
                  {passagem.custoUnitario} pts / viagem
                </p>
